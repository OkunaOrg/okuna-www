export const messages = {
    en: {
        ...
        privacy: {
            ...
            description: 'We\'re firm believers privacy is a fundamental human right. We don\'t track nor monitor your activity.'
        },
        secure: {
            title: 'Secure by design',
            description: 'Our background is information security. We are baking in security, right from the start.'
        },
        easy: {
            title: 'Friendly and relaxed',
            description: 'Through a combination of our <a href="https://github.com/OkunaOrg/Okuna-api/blob/master/docs/COMMUNITY_GUIDELINES.md" rel="noreferrer noopener nofollow">community-crafted guidelines</a>, ethical design and code, we foster an environment of friendliness, respect and openess where happiness is the end goal.'
        },
        fun: {
        ...
        personal: {
            title: 'Customisable',
            description: 'We\'re all different and that\'s something to embrace and celebrate. With customisation features, make the network feel just like home!'
        },
        community: {
        ...
        quotes: {
            ...
            phil_quote: 'Okuna holds hope for the future, a social network where we are not victims of its business model.'
        },
        splash_hero: {
        ...
        why_ob: {
            ...
            future_proof_desc: 'With a solid and useful business model based on peer-to-peer transactions, we are in for the long run.',
        ...
        count_down: {
            ...
            kickstarter_launch: 'Okuna <strong class="has-text-kickstarter">alpha</strong> ' +
        ...
        hud: {
            ...
            share_title: 'Okuna. A social network for a better future.',
        ...
        about_us: {
            ...
            description: '<strong>We\'re a team of engineers, designers, hackers, activists and information-security experts building human-centric, responsible, sustainable and fair technology for a more prosperous tomorrow.</strong>',
            ...
            description_funded: 'We successfully <a href="https://www.kickstarter.com/projects/1520156881/openbook-privacy-friendly-fun-and-honest-social-ne" rel="noopener noreferrer">crowd-funded</a> <span class="has-text-circular">Okuna</span> on September 2018 and is currently in alpha testing with 3,500+ members.',
        ...
        faq: {
            ...
            improve_website: 'If you\'re a developer, you can help us <a\n' +
                '                            href="https://github.com/OkunaOrg"\n' +
            ...
            contact_us: 'contact us',
            looking_for_job: 'If you\'re looking for a job and believe Okuna would be a great fit for you,',
        ...
        manifesto: {
            ...
            We_want_to: "We want to do better, which is exactly why at Okuna we’re doing things differently.",
            Okuna_will_have: "We're designing a social network with humanity's best qualities such as kindness, compassion, tolerance, charity, empathy and cooperation at its core",
            honest_pe: "An ethical social network for a brighter tomorrow.",
            ...
            On_Openboo: "You'll be able to craft an experience suited just for you. From changing the color of your timeline, adding cool extra widgets in your profile to choosing how you want to see content in your timeline, we want Okuna to feel familiar, friendly and cozy to you. Just like home.",
            And_if_the: "And if there’s anything you’re missing on Okuna, let us know. We want to build Okuna together. We will create a special group where we encourage you to help us decide what we build next or what we should improve. Let’s build the best social experience ever, together.",
            this_is_what_drove: "This is what initially drove us to build Okuna. The privacy and security of our users will always be at the core of everything we do. We don’t track anything you do, neither monetize your information nor share it without your explicit and informed consent.",
            ...
            In_order_t: "In order to use Songipy you must continue with Okuna.",
            continue_with_ob: "Continue with <strong>Okuna</strong>",
            ...
            Lets_not_: "While the intial drive for Okuna was building a privacy-friendly social network, the complications of existing social networks span to numerous other subjects. Fear of missing out, digital social status, discrimination, digital mobbing, censorship and more.",
            ...
            instead_our_revenue: "Our revenue model is an optional subscription called <span class=\"has-text-circular\"><strong>Okuna</strong> Gold</span> offering access to more reactions, themes and customization options.",
            ...
            Okuna_h: "Okuna has now shared your information with Songipy.",
