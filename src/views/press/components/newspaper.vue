<template>
    <div>
        <svg version="1.1" id="feed-icon-svg" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" width="100px" height="100px" viewBox="0 0 100 100" enable-background="new 0 0 100 100" xml:space="preserve">
<g id="page-right">
	<g id="page-three-right">
		<path class="newspaper-bg-overlay" d="M99.213,0H50v25h41.373C91.806,25,92,25.566,92,26.144v5.229C92,31.95,91.806,32,91.373,32H50v68h49.213
			c0.435,0,0.787-0.076,0.787-0.654v-98.3C100,0.468,99.647,0,99.213,0z"/>
...
<style lang="scss">
    ...
    #feed-icon-svg {
        margin: 50px auto;
        display: block;
        animation: newspaper-spin 1s ease;
    ...
    @-webkit-keyframes page-right {
        ...
        100% { transform: rotateY(90deg); visibility: visible; }
    }
